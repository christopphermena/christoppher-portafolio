...
export const SITE: SiteConfig = {
  ...
  locale: 'es_CL',
  social: {
    github: 'https://github.com/christopphermena',
    linkedin: 'https://www.linkedin.com/in/christopphermena/',
    email: 'mailto:christopphermena@gmail.com',
  },
}
